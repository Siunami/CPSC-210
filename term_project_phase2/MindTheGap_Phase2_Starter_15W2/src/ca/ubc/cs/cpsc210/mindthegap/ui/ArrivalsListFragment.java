...
public class ArrivalsListFragment extends ListFragment {
    ...
    public ArrayList<Arrival> getArrivalsForSelectedStationOnLineInDirection(String lineId, String travelDirn) {
        ArrivalBoardListFragment a = new ArrivalBoardListFragment();
        ArrayList<ArrivalBoard> arrivalBoards = a.getArrivalBoardsForSelectedStation();
        ArrayList<Arrival> arrivalList = new ArrayList<>();

        Iterator itr = arrivalList.iterator();
